...
def generateClassicGameBoard() -> GameBoard:
    ...
    block1 = StreetBlock(block1_image, "Block 2", 1, 60, 30, [], [], "red",0)
    ...
    block3=StreetBlock(block3_image, "Block 3", 3, 60, 30, [], [], "red",0)
    ...
    station1 = RailroadBlock(station1_image, "Station 1", 5, 200, 100, [])
    station1.rect.topleft = (340, 640)
    board.addBlock(station1)
    #
    block6_image = pygame.image.load("Assets/Classic Board/light blue.png")
    block6 = StreetBlock(block6_image, "Block 6", 6, 100, 50, [], [], "light_blue",0)
    ...
    block8 = StreetBlock(block8_image, "Block 8", 8, 100, 50, [], [], "light_blue",0)
    block8.rect.topleft = (160, 640)
    board.addBlock(block8)
    #
    block9_image = pygame.image.load("Assets/Classic Board/light blue.png")
    block9 = StreetBlock(block9_image, "Block 9", 9, 120, 60, [], [], "light_blue",0)
    ...
    block11 = StreetBlock(block11_image, "Block 11", 11, 140, 70, [], [], "purple",0)
    ...
    utility1 = UtilityBlock(utility1_image, "Electric Company", 12, 150, 75, [])
    ...
    block13 = StreetBlock(block13_image, "Block 13", 13, 140, 70, [], [], "purple",0)
    ...
    block14 = StreetBlock(block14_image, "Block 14", 14, 160, 80, [], [], "purple",0)
    ...
    station2 = RailroadBlock(station2_image, "Station 2", 15, 200, 100, [])
    ...
    block16 = StreetBlock(block16_image, "Block 16", 16, 180, 90, [], [], "light_green",0)
    ...
    block18 = StreetBlock(block18_image, "Block 18", 18, 180, 90, [], [], "light_green",0)
    ...
    block19 = StreetBlock(block19_image, "Block 19", 19, 200, 100, [], [], "light_green",0)
    ...
    block21 = StreetBlock(block21_image, "Block 21", 21, 220, 110, [], [], "orange",0)
    ...
    block23 = StreetBlock(block23_image, "Block 23", 23, 220, 110, [], [], "orange",0)
    ...
    block24 = StreetBlock(block24_image, "Block 24", 24, 240, 120, [], [], "orange",0)
    ...
    station3 = RailroadBlock(station3_image, "Station 3", 25, 200, 100, [])
    ...
    block26 = StreetBlock(block26_image, "Block 26", 26, 260, 130, [], [], "yellow",0)
    ...
    block27 = StreetBlock(block27_image, "Block 27", 27, 260, 130, [], [], "yellow",0)
    ...
    utility2 = UtilityBlock(utility2_image, "Water Works", 28, 150, 75, [])
    ...
    block29 = StreetBlock(block29_image, "Block 29", 29, 280, 140, [], [], "yellow",0)
    ...
    block31 = StreetBlock(block31_image, "Block 31", 31, 300, 150, [], [], "green",0)
    ...
    block32 = StreetBlock(block32_image, "Block 32", 32, 300, 150, [], [], "green",0)
    ...
    block34 = StreetBlock(block34_image, "Block 34", 34, 320, 160, [], [], "green",0)
    ...
    station4 = RailroadBlock(station4_image, "Station 4", 35, 200, 100, [])
    ...
    block37 = StreetBlock(block37_image, "Block 37", 37, 350, 175, [], [], "blue",0)
    ...
    block39 = StreetBlock(block39_image, "Block 39", 39, 400, 200, [], [], "blue",0)
