...
class ActionMenuWindow:
    def __init__(self, screen_size):
        ...
        self.window = pygame.transform.scale(pygame.image.load("Assets/action menu/white.png"), (int(self.screen_width * 0.4), int(self.screen_height)))
        # player information
        self.player_name = COMIC_SANS18.render("Name: ", 1, "#333333")
        self.player_balance = COMIC_SANS18.render("Balance: ", 1, "#333333")
