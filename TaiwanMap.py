...
def generateClassicGameBoard() -> GameBoard:
    board = GameBoard()
    #
    go_image = pygame.image.load("Assets/Classic Board")
    go = StartBlock(go_image, "Go", 0, 200)
    go.rect.topleft = (640, 640)
    board.addBlock(go)
    #
    block1_image = pygame.image.load("Assets/TaiwanBoard/Blcoks/red.png")
    ...
    #
    commuity_chest1_image = pygame.image.load("Assets/TaiwanBoard/Blcoks/event.png")
    ...
    #
    block3_image=pygame.image.load("Assets/TaiwanBoard/Blcoks/red.png")
    ...
    #
    income_tax_image = pygame.image.load("Assets/TaiwanBoard/Blcoks/event.png")
    income_tax = IncomeTaxBlock(income_tax_image, "Income Tax", 4, 200)
    income_tax.rect.topleft = (400, 640)
    board.addBlock(income_tax)
    #
    station1_image = pygame.image.load("Assets/TaiwanBoard/Blcoks/event.png")
    ...
    #
    block6_image = pygame.image.load("Assets/TaiwanBoard/Blcoks/light blue.png")
    ...
    #
    chance1_image = pygame.image.load("Assets/TaiwanBoard/Blcoks/event.png")
    chance1 = ChanceBlock(chance1_image, "Chance", 7, [])
    chance1.rect.topleft = (220, 640)
    board.addBlock(chance1)
    #
    block8_image = pygame.image.load("Assets/TaiwanBoard/Blcoks/light blue.png")
    ...
    #
    block9_image = pygame.image.load("Assets/TaiwanBoard/Blcoks/light blue.png")
    ...
    #
    in_jail_or_just_visit_image = pygame.image.load("Assets/TaiwanBoard/Blcoks/corner.png")
    ...
    #
    block11_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/purple.png"), 270)
    ...
    #
    utility1_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/event.png"), 270)
    ...
    #
    block13_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/purple.png"), 270)
    ...
    #
    block14_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/purple.png"), 270)
    ...
    #
    station2_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/event.png"), 270)
    ...
    #
    block16_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/light green.png"), 270)
    ...
    #
    commuity_chest2_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/event.png"), 270)
    ...
    #
    block18_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/light green.png"), 270)
    ...
    #
    block19_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/light green.png"), 270)
    ...
    #
    free_parking_image = pygame.image.load("Assets/TaiwanBoard/Blcoks/corner.png")
    ...
    #
    block21_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/orange.png"), 180)
    ...
    #
    chance2_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/event.png"), 180)
    chance2 = ChanceBlock(chance2_image, "Chance", 22, [])
    chance2.rect.topleft = (160, 20)
    board.addBlock(chance2)
    #
    block23_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/orange.png"), 180)
    ...
    #
    block24_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/orange.png"), 180)
    ...
    #
    station3_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/event.png"), 180)
    ...
    #
    block26_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/yellow.png"), 180)
    ...
    #
    block27_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/yellow.png"), 180)
    ...
    #
    utility2_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/event.png"), 180)
    utility2 = UtilityBlock(utility2_image, "Water Works", 28, 150, 75, [100, 250])
    utility2.rect.topleft = (520, 20)
    board.addBlock(utility2)
    #
    block29_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/yellow.png"), 180)
    ...
    #
    go_to_jail_image = pygame.image.load("Assets/TaiwanBoard/Blcoks/corner.png")
    go_to_jail = ImprisonBlock(go_to_jail_image, "Go To Jail", 30)
    go_to_jail.rect.topleft = (640, 20)
    board.addBlock(go_to_jail)
    #
    block31_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/green.png"), 90)
    ...
    #
    block32_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/green.png"), 90)
    ...
    #
    commuity_chest3_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/event.png"), 90)
    ...
    #
    block34_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/green.png"), 90)
    ...
    #
    station4_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/event.png"), 90)
    ...
    #
    chance3_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/event.png"), 90)
    chance3 = ChanceBlock(chance3_image, "Chance", 36, [])
    chance3.rect.topleft = (640, 400)
    board.addBlock(chance3)
    #
    block37_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/blue.png"), 90)
    ...
    #
    super_tax_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/event.png"), 90)
    super_tax = LuxuryTaxBlock(super_tax_image, "Super Tax", 38, 100)
    super_tax.rect.topleft = (640, 520)
    board.addBlock(super_tax)
    #
    block39_image = pygame.transform.rotate(pygame.image.load("Assets/TaiwanBoard/Blcoks/blue.png"), 90)
...
def generateEventCards():
    ...
    # 小新的車車
    image_2 = pygame.image.load("Assets/EventCards/Chance/小新的車車.jpg")
    ...
    # 出事了阿北
    image_3 = pygame.image.load("Assets/EventCards/Chance/出事了阿北.jpg")
    ...
    # 外星人
    image_4 = pygame.image.load("Assets/EventCards/Chance/外星人.jpg")
    ...
    # 快不行了
    image_5 = pygame.image.load("Assets/EventCards/Chance/快不行了.jpg")
    ...
    # 穿牆術
    image_6 = pygame.image.load("Assets/EventCards/Chance/穿牆術.jpg")
    ...
    # 野豬騎士
    image_7 = pygame.image.load("Assets/EventCards/Chance/野豬騎士.jpg")
    ...
    # 撿到錢包
    image_8 = pygame.image.load("Assets/EventCards/Chance/撿到錢包.jpg")
    ...
    # 幫幫人民的啦
    image_9 = pygame.image.load("Assets/EventCards/Chance/幫幫人民的啦.jpg")
    ...
    # chill guy
    image_10 = pygame.image.load("Assets/EventCards/chance/chill guy.jpg")
    ...
    # 大爆炸
    image_11 = pygame.image.load("Assets/EventCards/CommunityChest/大爆炸.jpg")
    def explosion(players, blocks):
        pass
    communityChestDeck.append(EventCard(image_11, 2, need_selection=False, effect=explosion))

    # 月光刑警
    image_12 = pygame.image.load("Assets/EventCards/CommunityChest/月光刑警.jpg")
